...
MODULE_DESCRIPTION("DIANA-OS Kernel Core v0.1 — "
...
static int __init diana_init(void)
{
    ...
    pr_info("╔═══════════════════════════════════════════════════╗\n");
    pr_info("║  DIANA-OS Kernel Core v0.1 — Initializing...     ║\n");
    ...
    pr_info("╔═══════════════════════════════════════════════════╗\n");
    pr_info("║  DIANA-OS Kernel Core v0.1 — READY               ║\n");
...
static void __exit diana_exit(void)
{
    ...
    pr_info("╔═══════════════════════════════════════════════════╗\n");
    pr_info("║  DIANA-OS Kernel Core — UNLOADED                 ║\n");
